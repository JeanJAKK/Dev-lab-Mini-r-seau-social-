...
export default function UserProfile() {
  ...
  const getAvatarUrl = (p) => {
    if (!p) return `https://ui-avatars.com/api/?name=U&background=7c3aed&color=fff`;
    if (p.avatar_url) return p.avatar_url;
    return `https://ui-avatars.com/api/?name=${encodeURIComponent(p.name || "U")}&background=7c3aed&color=fff`;
  };
