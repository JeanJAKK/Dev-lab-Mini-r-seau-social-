...
export default function CentreNotifications() {
  ...
  const handleNotificationClick = async (notif) => {
    if (!notif.lu) {
      ...
      try {
        ...
        setNotifications((prev) =>
          prev.map((n) => (n.id === notif.id ? { ...n, lu: false } : n)),
        );
      }
    }
  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-300 ${isDark ? "bg-gray-900" : "bg-gradient-to-br from-gray-50 to-gray-100"}`}
    >
      <div className="w-full sm:w-[70%] max-w-[1100px] mx-auto px-0 sm:px-3 py-4">
        <div
          className={`rounded-2xl border shadow-xl mb-4 overflow-hidden transition-colors duration-300 ${
            isDark
        ...
        >
          <div className="px-5 py-4">
            <div className="flex flex-nowrap items-center justify-between gap-3 overflow-x-auto">
              <div className="flex items-center gap-2 min-w-0">
                ...
                <h1
                  className={`font-bold text-2xl md:text-3xl tracking-tight text-transparent bg-clip-text bg-gradient-to-r ${
                    isDark
          ...
          <div
            className={`flex border-t ${isDark ? "border-gray-700" : "border-gray-100"}`}
          >
            <button
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2">
                        <div className="flex-1">
                          <div className="flex items-center gap-1.5 flex-wrap">
                            <span
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                navigate(
                                  `/home/profile/${notif.expediteur_id}`,
                                );
                              }}
                            >
                              {notif.nom}
                          ...
                          <div
                            className={`flex items-center gap-2 mt-1.5 text-xs ${isDark ? "text-gray-500" : "text-gray-400"}`}
                          >
                        ...
                        <div className="flex items-center gap-1 shrink-0">
                          ...
                          {menuOpen === notif.id && (
                            <div
                              className={`absolute right-2 top-12 rounded-xl shadow-2xl border py-2 z-50 min-w-[180px] ${
                                isDark
                            ...
                            >
                              ...
                              <div
                                className={`border-t my-1 ${isDark ? "border-gray-700" : "border-gray-150"}`}
                              ></div>
                              <button
                                onClick={(e) => {
                                  e.stopPropagation();
        ...
        {notifsFiltrees.length > 0 && (
          <div className="mt-6 text-center">
            <p
              className={`text-xs inline-block px-4 py-1.5 rounded-full shadow-sm ${
                isDark
